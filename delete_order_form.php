...
<html>
    ...
    <body>
        ...
        <center>
            ...
            ?>
            <!-- The form section -->
            <form onsubmit = "if(!confirm('Are you sure you want to delete this order? This action cannot be undone.')){return false;}" action = "./delete_order.php" method = "post" id = "delete_order_form">
                <p>Select an order to delete below using the radio buttons.</p>
                <table border = "1">
                ...
                <br>
                <input type = "submit" class="btn btn-warning" name = "submit" id = "submit" value = "Remove Selected Order"> <!-- This button is used to submit the completed form -->
