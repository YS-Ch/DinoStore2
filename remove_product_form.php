...
<html>
    ...
    <head> <!-- The document's header with the metadata is in this section -->
        ...
        <title>Dino Store Remove Product</title> <!-- This is the title of the web page -->
    ...
    <body>
        ...
        <center>
            ...
            ?>
            <!-- The form section -->
            <form onsubmit = "if(!confirm('Are you sure you want to delete this product? This action cannot be undone.')){return false;}" action = "./remove_product.php" method = "post" id = "add_product_form">
                <p>Select a product to remove below using the radio buttons.</p>
                <table class = "null" border = "1">
                    ...
                    <tr>
                        <?php $count += 1; ?>
                        <td><input type = "radio" name = "selected" value = "<?php echo $product['productID']; ?>" required = "true"></td>
                        <td><img style = "height: 150px; width: 150px;" src = "<?php echo $product['productImage']; ?>" alt = "Product Image"></td> <!-- This displays the product image -->
                ...
                <br>
                <input type = "submit" class="btn btn-warning" name = "submit" id = "submit" value = "Remove Selected Product"> <!-- This button is used to submit the completed form -->
