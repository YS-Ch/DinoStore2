...
<html>
    ...
    <body>
        ...
        <center>
            ...
            ?>
            <!-- The form section -->
            <form onsubmit = "if(!confirm('Are you sure you want to refund this order? This action cannot be undone.')){return false;}" action = "./refund_order.php" method = "post" id = "refund_order_form">
                <p>Select an order to refund below using the radio buttons.</p>
                <table border = "1">
                    ...
                    <tr>
                        <?php if ($order['refunded'] == 0 || $order['refunded'] == false) { ?>
                            <?php $count += 1; ?>
                            <td><input type = "radio" name = "selected" value = "<?php echo $order['orderID']; ?>" required = "true"></td>
                ...
                <br>
                <input type = "submit" class="btn btn-warning" name = "submit" id = "submit" value = "Refund Selected Order"> <!-- This button is used to submit the completed form -->
        ...
        <!-- The footer section -->
        <footer>
            <hr color = "green"> <!-- Green Horizontal Line -->
